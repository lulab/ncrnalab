...
> 人类有大约2万个蛋白编码基因，但其序列的总长度仅占人类基因组总长度的1.5%左右。另一方面，人类基因组序列的~70%甚至更多都会被转录成RNA，它们很多都是非编码的RNA（**noncoding RNA**，**ncRNA**)。但对于为数众多的**非编码RNA** (**ncRNA**)，我们知之甚少。
>
...
### 1. RNA-RNA Model for Target Prediction
...
### 2. RNA-Ligand Model for Drug Design
...
### 3. RNA Structure Model for Enzyme and Vaccine Design
