...
# 项目一：针对癌症等复杂疾病的核酸检测项目 - AI驱动的cfRNA检测技术{#proj1}
...
# 项目二：RNA制药项目 - AI 驱动的RNA结构预测技术{#proj2}
